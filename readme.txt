...
The DB manager plugin allows you to download the latest version of PhpMyadmin and Dumper and manage your site.
...
<a href="http://wordpress.org/plugins/db-manager/faq/" target="_blank">FAQ</a>
...
= How can I Download phpMyadmin or Dumper? =

Click on the Download link.

= How can I remove phpMyadmin or Dumper? =

Click on the Delete link.

= How can I disable phpMyadmin or Dumper? =

Click on the Disable access link.

= How can I enable phpMyadmin or Dumper? =

Click on the Enable access link.
...
1. DB manager Settings download.
